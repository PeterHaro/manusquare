...
//    }
    ...
    public Process_OLD(String name) {
        this.name = name;
    }

    public Process_OLD(String name, Set<Material> materials, Set<Attribute> attributes) {
        super();
        this.name = name;
        this.materials = materials;
        this.attributes = attributes;
    ...
    public Process_OLD(String name, Set<Material> materials, Set<Attribute> attributes, Set<String> equivalentProcesses) {
        super();
        this.name = name;
        this.materials = materials;
        this.attributes = attributes;
    ...
    public Process_OLD(String name, Set<Material> materials, Map<String, String> attributeWeightMap) {
        super();
        this.name = name;
        this.materials = materials;
    ...
    public Process_OLD(String name, Set<Material> materials, Set<Attribute> attributes, Map<String, String> attributeWeightMap) {
        super();
        this.name = name;
        this.materials = materials;
        this.attributes = attributes;
    ...
    public Process_OLD(String name, Set<Material> materials) {
        super();
        this.name = name;
        this.materials = materials;
    }
...
//    }
    ...
    public boolean equals(Object o) {
        if (o instanceof Process_OLD && ((Process_OLD) o).getName().equals(this.name)) {
            return true;
        } else {
            return false;
        }

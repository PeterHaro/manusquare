...
public class ByProduct_OLD {
    ...
    private String uom;
    private Set<ByProductAttribute> attributes;
 ...
 //TODO: Clean up constructors and implement as builder DP. 
	...
	public ByProduct_OLD(String id, String name, String supplyType, int minParticipants, int maxParticipants, String purchasingGroupAbilitation, String quantity, double minQuantity, String uom, Set<String> materials,
    ...
    public ByProduct_OLD(String id, String name, String supplyType, int minParticipants, int maxParticipants, String purchasingGroupAbilitation, String quantity, String uom,  Set<String> materials, Set<String> appearances, Set<ByProductAttribute> attributes) {
        super();
        this.id = id;
        this.name = name;
        this.supplyType = supplyType;
...
//    }
    ...
    //Used by ByProductQuery
    public ByProduct_OLD(String id, String name, String supplyType, String quantity, String uom,int minParticipants, int maxParticipants, String purchasingGroupAbilitation) {
        super();
        this.id = id;
        this.name = name;
        this.supplyType = supplyType;
...
//	}
	...
	public Set<ByProductAttribute> getAttributes() {
        return attributes;
    }
	
	public Set<Attribute> getNormalisedAttributes(ByProduct_OLD bp) {
    ...
    public boolean equals(Object o) {
        if (o instanceof ByProduct_OLD && ((ByProduct_OLD) o).getId().equals(this.id) && ((ByProduct_OLD) o).getAttributeWeightMap() != null && this.getAttributeWeightMap() != null) {
            return true;
        } else {
            return false;
        }
